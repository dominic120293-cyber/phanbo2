...
def run_allocation(input_file_path, output_file_path):
    """
    Hàm chạy mô hình tối ưu hóa, đọc từ input_file_path và ghi kết quả vào output_file_path.
    """
    wb_data = openpyxl.load_workbook(input_file_path, data_only=True)
    ws_data = wb_data.active

    # Đọc danh sách STS từ dòng 1, cột J đến N
    sts_from_header = []
